...
async function saveDepartment() {
  const name = (document.getElementById("depName") as HTMLInputElement).value.trim();
  const parent_id = Number((document.getElementById("depParent") as HTMLSelectElement).value || 0);
  const notes = (document.getElementById("depNotes") as HTMLInputElement).value.trim();
...
async function saveEmployee() {
  const employee_number = (document.getElementById("empNumber") as HTMLInputElement).value.trim();
  const name = (document.getElementById("empName") as HTMLInputElement).value.trim();
  const national_id = (document.getElementById("empNationalId") as HTMLInputElement).value.trim();
  const qualification = (document.getElementById("empQualification") as HTMLInputElement).value.trim();
  const job_title = (document.getElementById("empJobTitle") as HTMLInputElement).value.trim();
  const department_id = Number((document.getElementById("empDepartment") as HTMLSelectElement).value || 0);
  const notes = (document.getElementById("empNotes") as HTMLInputElement).value.trim();
...
async function loadEvaluationMonth() {
  const year = Number((document.getElementById("evalYear") as HTMLSelectElement).value);
  const month = Number((document.getElementById("evalMonth") as HTMLSelectElement).value);
  const department_id = Number((document.getElementById("evalDepartment") as HTMLSelectElement).value || 0);
...
async function saveEvaluations() {
  ...
  document.querySelectorAll("#evaluationsTable tr").forEach((tr: any) => {
...
async function loadReport() {
  const year = Number((document.getElementById("reportYear") as HTMLSelectElement).value);
  const from_month = Number((document.getElementById("reportFromMonth") as HTMLSelectElement).value);
...
(window as any).saveDepartment = saveDepartment;
(window as any).saveEmployee = saveEmployee;
(window as any).loadEmployees = loadEmployees;
(window as any).loadEvaluationMonth = loadEvaluationMonth;
(window as any).saveEvaluations = saveEvaluations;
